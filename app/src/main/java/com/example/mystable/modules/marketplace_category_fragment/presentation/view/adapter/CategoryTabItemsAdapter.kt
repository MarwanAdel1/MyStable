package com.example.mystable.modules.marketplace_category_fragment.presentation.view.adapter
...
import com.example.mystable.modules.marketplace_category_fragment.presentation.view.MarketplaceCategoryItemsCallback
    ...
    override fun onBindViewHolder(holder: MarketplaceCategoryDetailsViewHolder, position: Int) {
        holder.binding.apply {
            ...
            Glide.with(myContext)
                .load(categoryDetailsItems.categoryItemData[position].imageUrl)
