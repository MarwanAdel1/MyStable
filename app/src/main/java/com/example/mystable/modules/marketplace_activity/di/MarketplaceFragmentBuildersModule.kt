...
import com.example.mystable.modules.marketplace_posts_fragment.di.MarketplacePostsFragmentModule
import com.example.mystable.modules.marketplace_posts_fragment.di.MarketplacePostsFragmentScope
import com.example.mystable.modules.marketplace_posts_fragment.di.MarketplaceViewModelsModule
...
abstract class MarketplaceFragmentBuildersModule {
    ...
    abstract fun contributeMarketplaceFragment(): MarketplacePostsFragment
