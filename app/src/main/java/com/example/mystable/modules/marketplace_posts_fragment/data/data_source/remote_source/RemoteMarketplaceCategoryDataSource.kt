package com.example.mystable.modules.marketplace_posts_fragment.data.data_source.remote_source

import com.example.mystable.modules.marketplace_posts_fragment.data.api.CategoryDataSourceService
...
class RemoteMarketplaceCategoryDataSource @Inject constructor(private val marketApi: CategoryDataSourceService) :
